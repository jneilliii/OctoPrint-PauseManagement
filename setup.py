...
plugin_identifier = "pause_management"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_pause_management"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Pause Management"
...
# module
plugin_description = """Plugin allowing to ignore upcoming pauses in gcode or add additional pauses while printing."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-PauseManagement"
